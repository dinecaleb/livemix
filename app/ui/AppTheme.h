...
// ---------------------------------------------------------------------------
// DINELIVE v2 look: native macOS, dark. Materials are flat (desk / window / card /
...
namespace Dine
{
    ...
    namespace Metric
    {
        ...
        inline constexpr int toolbar   = 52;
    ...
    enum class Icon
    {
        ...
        Device, List, Target, Check, Warn, Gear, Play, Refresh, Chevron, UpDown, Dash, Bus
    };
